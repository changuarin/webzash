	...
	<div id="menu">
		<ul class="sf-menu">
			...
			<li>
				...
				if( check_access('agent ref. no.') ):?>
					<li><?php echo anchor('master/referenceno', 'Agent Ref. No.', array('title' => 'Agent Ref. No.')); ?></li><?
				endif;
				?><li><?php echo anchor('master/verification', 'Verification', array('title' => 'Verification')); ?></li><?php
				if( check_access('commission') ):?>
			...
			?><li>
				...
				<ul>
					...
					<li><?php echo anchor('sales/rpcf', 'RPCF', array('title' => 'RPCF')); ?></li>
					<li><?php echo anchor('sales/refund', 'Refund', array('title' => 'Refund')); ?></li>
				</ul>
			</li><?
			endif; ?>
			...
			?><li>
				...
				<ul>
					...
					<li><?php echo anchor('report/rpcf/' . date('Y-m-d') . '/0', 'RPCF Summary', array('title' => 'RPCF')); ?></li>
