...
<body>
	<div id="main">
		<div>
			<h2>Loan Duration Form</h2>
		</div>
		<form action="../../../../../update_loan_duration" id="edit_loan_form" method="post">
			<div>
				<label>Start Date</label>
				&nbsp;
				<input class="center" id="lh_startdate" type="text" name="lh_startdate" value="<?= $lh_startdate ?>" required />
			</div>
			<div>
				<label>End Date</label>
				&nbsp;
				<input class="center" id="lh_enddate" type="text" name="lh_enddate" value="<?= $lh_enddate ?>" required />
			</div>
			<div style="padding-left: 60px;">
				<input id="lh_loandate" type="hidden" name="lh_loandate" value="<?= $lh_loandate ?>" />
...
<script type="text/javascript">
	var main = function() {
		$('#submit-btn').click(function() {
			if(confirm('Update loan duration?')) {
