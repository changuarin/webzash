...
<body>
	...
	<div id="print-report-period">
		<span class="value"><? if(isset($isreport)): 
			echo $reportname;
		else:?>
			Financial year<br />
			<?php echo date_mysql_to_php_display($this->config->item('account_fy_start')); 
			?> - <?php echo date_mysql_to_php_display($this->config->item('account_fy_end')); 
		endif;
		?>
		</span>
	</div>
