...
if(isset($datas)):
	...
	foreach ($datas as $d):
		...
		echo trims("
			...
			<td nowrap><span style='font-family:Arial Narrow'>" . (strlen($name) > 20 ? substr($name, 0, 19) . '..' : $name ) . "</span></td>
		...
		if($ctrlimit==25&&isset($isreport))
		{
			...
			echo trims("
				...
				<td class='bold' colspan='4' style='text-align:right;'>" . (isset($isreport) ?
	...
	echo trims("
		<tr class='total-area'>
			...
			"<tr>
				<td class='bold' colspan='8' style='text-align:right'>Total Bank Charge</td>
				<td class='bold' style='text-align:right'>$gtcharge</td>
			</tr>
			<tr>
				<td class='bold' colspan='8' style='text-align:right'>Total NetDue</td>
