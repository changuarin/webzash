...
class Ledger extends Controller {
	...
	function add()
	{
		...
		/* Form validations */
		$this->form_validation->set_rules('ledger_code', 'Ledger code', 'trim|required|min_length[2]|max_length[7]|unique[ledgers.code]');
	...
	function edit($id)
	{
		...
		/* Form validations */
		$this->form_validation->set_rules('ledger_code', 'Ledger code', 'trim|required|min_length[2]|max_length[7]|uniquewithid[ledgers.code.' . $id . ']');
